...
const chartData = [
  { name: 'Optimizely', score: 59.4, logo: '🔵', color: '#3B82F6' },
  { name: 'Dynamic Yield', score: 42.4, logo: '🔴', color: '#EF4444' },
  { name: 'VWO', score: 37.2, logo: '🟣', color: '#8B5CF6' },
  { name: 'Intellimize', score: 29.5, logo: '💡', color: '#06B6D4' },
  { name: 'Fibr', score: 24.0, logo: '🎯', color: '#10B981' },
]

const rankings = [
  { rank: 1, name: 'Optimizely', logo: '🔵', score: '59.4%', isOwner: false },
  { rank: 2, name: 'Dynamic Yield', logo: '🔴', score: '42.4%', isOwner: false },
  { rank: 3, name: 'VWO', logo: '🟣', score: '37.2%', isOwner: false },
  { rank: 4, name: 'Intellimize', logo: '💡', score: '29.5%', isOwner: false },
  { rank: 6, name: 'Fibr', logo: '🎯', score: '24%', isOwner: true },
]
